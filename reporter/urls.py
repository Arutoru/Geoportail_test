...
urlpatterns= [
    ...
    path('aot_data/', GeoJSONLayerView.as_view(model=Aot, properties=('amodiataire', 'niu', 'rccm', 'duree_bail', 'tel', 'superficie', 'date_caution', 'date_fin', 'montant_caution', 'localisation', 'statut', 'remarque')), name='aot_data'),
